# Detector v3 Validation Report — 2026-08-04

Frozen version: `candle-detector-v3-robust@20260804` (read-only analysis)

| Symbol | v2 flags | v3 flags | both | v3-only | v2-only | FP: calendar gaps | FP: DXY boundary | missed corruption |
|---|---|---|---|---|---|---|---|---|
| XAUUSD | 114 | 118 | 112 | 6 | 2 | 2 | 0 | 0 |
...
- **XAUUSD**: {"LARGE_JUMP_ROBUST":115,"UNEXPECTED_GAP":7}
