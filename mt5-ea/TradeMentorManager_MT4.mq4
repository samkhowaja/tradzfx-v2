...
int OnInit()
{
   ...
   {
      int login = AccountNumber();
      g_effectiveApiKeyFile = "tm_api_key_mt4_" + IntegerToString(login) + ".txt";
   }
...
void ExecuteSignalJson(string sigJson, bool paperMode)
{
   ...
   int ticket = (int)TMOpenMarket(symbol, side, lots, sl, tp, g_cfg.maxSlippagePoints,
