...
//|    Add: http://127.0.0.1:3002  (tradzfx V2 web app)          |
...
#property description "Pushes M1 candles + executes trade signals + work queue commands from tradzfx-v2 server (v4.22)"
#property strict
