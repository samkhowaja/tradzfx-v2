//+------------------------------------------------------------------+
//|                                       TradeMentorSync_MT4.mq4    |
//|                        TradeMentor AI -- MT4 Execution EA        |
//|                                                                  |
//| PURPOSE:                                                         |
//| Execute trade signals from TradeMentor server on MT4 accounts.   |
...
//| 4. Set your API Key (from TradeMentor -> Accounts -> MT5 Conn)  |
//| 5. EA will poll for signals, execute, and sync account info      |
//+------------------------------------------------------------------+
#property copyright "TradeMentor AI"
#property version   "1.00"
#property description "MT4 execution-only EA: trade signals + account sync (v1.0)"
#property strict

//--- Input parameters
input string InpApiKey           = "tm_mt5_c7bd065c088f4aec837070ce18190770"; // API Key (from TradeMentor)
...
//--- Constants
#define EA_NAME          "TradeMentorSync_MT4"
